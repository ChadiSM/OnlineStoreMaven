...
/**
 * <p>
 * La clase {@link modelo.comparador.ComparadorClienteNIF} implementa a
 * {@link java.util.Comparator} con el propósito de ordenar y distinguir objetos
 * similares de la clase {@link modelo.Cliente} por su Número de Identificación
 * Fiscal.</p>
 * <p>
 ...
 * nos convenga.</p>
 */
public class ComparadorClienteNIF implements Comparator<Cliente> {

    /**
     * Comparador para ordenar por el Número de Identificación Fiscal (código
     * alfanumérico) una colección de clientes.
     *
    ...
    public int compare(Cliente c1, Cliente c2) {
        return c1.getNif().compareToIgnoreCase(c2.getNif());
    }
}
