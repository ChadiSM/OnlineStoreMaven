...
/**
 * <p>
 * La clase {@link modelo.comparador.ComparadorArticuloPVP} implementa a
 * {@link java.util.Comparator} con el propósito de ordenar y distinguir objetos
 * similares de la clase {@link modelo.Articulo} por su Precio de Venta al
 * Público.</p>
 * <p>
 ...
 * nos convenga.</p>
 */
public class ComparadorArticuloPVP implements Comparator<Articulo> {

    /**
     * Comparador para ordenar por el Precio de Venta al Público una colección
     * de artículos.
     *
    ...
    public int compare(Articulo a1, Articulo a2) {
        return a1.getPvp().compareTo(a2.getPvp());
    }
}
